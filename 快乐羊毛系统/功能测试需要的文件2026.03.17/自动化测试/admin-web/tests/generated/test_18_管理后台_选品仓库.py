...
"""
18_管理后台_选品仓库 · 自动化测试
来源文件: 18_管理后台_选品仓库.xlsx
用例数量: 43 条

运行方法:
  cd admin-web
  pytest tests/generated/test_18_管理后台_选品仓库.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_18_管理后台_选品仓库.py -v              # 无头模式
  pytest tests/generated/test_18_管理后台_选品仓库.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
