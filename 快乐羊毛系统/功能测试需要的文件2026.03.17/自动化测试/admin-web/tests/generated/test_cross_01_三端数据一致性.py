# -*- coding: utf-8 -*-
"""
cross_01_三端数据一致性 · 自动化测试
共 6 条用例
来源模块: 三端数据一致性 验证

运行方法:
  pytest admin-web/tests/generated\test_cross_01_三端数据一致性.py -v --headed     # 有界面
  pytest admin-web/tests/generated\test_cross_01_三端数据一致性.py -v              # 无头模式
  pytest admin-web/tests/generated\test_cross_01_三端数据一致性.py -k "test_fyxt"  # 只跑编号含fyxt的
"""
import pytest
import sys
