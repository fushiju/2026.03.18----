# -*- coding: utf-8 -*-
"""
20_管理后台_分佣场景补充 · 自动化测试
来源文件: 20_管理后台_分佣场景补充.xlsx
用例数量: 17 条

运行方法:
  cd admin-web
  pytest tests/generated/test_20_管理后台_分佣场景补充.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_20_管理后台_分佣场景补充.py -v              # 无头模式
  pytest tests/generated/test_20_管理后台_分佣场景补充.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
