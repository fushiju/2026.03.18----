# -*- coding: utf-8 -*-
"""
06_用户端_餐饮折扣（品牌会员共享模式二：人工辅助_验证码） · 自动化测试
来源文件: 06_用户端_餐饮折扣（品牌会员共享模式二：人工辅助_验证码）.xlsx
用例数量: 38 条

运行方法:
  cd admin-web
  pytest tests/generated/test_06_用户端_餐饮折扣_品牌会员共享模式二_人工辅助_验证码.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_06_用户端_餐饮折扣_品牌会员共享模式二_人工辅助_验证码.py -v              # 无头模式
  pytest tests/generated/test_06_用户端_餐饮折扣_品牌会员共享模式二_人工辅助_验证码.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
...
class Test餐饮折扣品牌会员共享模式二人工辅助_验证码:
    """06_用户端_餐饮折扣（品牌会员共享模式二：人工辅助_验证码） (38条)"""
    ...
    #   8. 提交成功，提示"商户信息已提交，待审核"
        #
        # ── 备注: 商家名称：测试火锅店；地址：深圳市南山区xxx；电话：13800138000；折扣：8.5折 ──
