# -*- coding: utf-8 -*-
"""
43_管理后台_管理后台异常测试 · 自动化测试
来源文件: 43_管理后台_管理后台异常测试.xlsx
用例数量: 3 条

运行方法:
  cd admin-web
  pytest tests/generated/test_43_管理后台_管理后台异常测试.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_43_管理后台_管理后台异常测试.py -v              # 无头模式
  pytest tests/generated/test_43_管理后台_管理后台异常测试.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
