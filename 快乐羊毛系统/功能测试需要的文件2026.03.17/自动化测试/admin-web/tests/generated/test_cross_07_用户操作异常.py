# -*- coding: utf-8 -*-
"""
cross_07_用户操作异常 · 自动化测试
共 4 条用例
来源模块: 用户操作异常 (用户端)

运行方法:
  pytest admin-web/tests/generated\test_cross_07_用户操作异常.py -v --headed     # 有界面
  pytest admin-web/tests/generated\test_cross_07_用户操作异常.py -v              # 无头模式
  pytest admin-web/tests/generated\test_cross_07_用户操作异常.py -k "test_fyxt"  # 只跑编号含fyxt的
"""
import pytest
import sys
