# -*- coding: utf-8 -*-
"""
67_用户端_个人中心(小程序环境) · 自动化测试
来源文件: 67_用户端_个人中心(小程序环境).xlsx
用例数量: 5 条

运行方法:
  cd admin-web
  pytest tests/generated/test_67_用户端_个人中心_小程序环境.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_67_用户端_个人中心_小程序环境.py -v              # 无头模式
  pytest tests/generated/test_67_用户端_个人中心_小程序环境.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
...
class Test个人中心小程序环境:
    ...
    #   5. 登录成功，个人中心显示脱敏手机号（138****8000）
        #
        # ── 备注: 小程序获取手机号必须用<button>组件，不能js直接调用 ──
    ...
    #   5. 拒绝授权时提示"请在设置中开启相册权限"
        #
        # ── 备注: 小程序saveImage需要scope.writePhotosAlbum授权 ──
