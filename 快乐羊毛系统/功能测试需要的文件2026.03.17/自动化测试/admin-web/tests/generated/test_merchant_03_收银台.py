# -*- coding: utf-8 -*-
"""
merchant_03_收银台 · 自动化测试
共 4 条用例
来源模块: 商家端收银台 (小程序环境)

运行方法:
  pytest admin-web/tests/generated\test_merchant_03_收银台.py -v --headed     # 有界面
  pytest admin-web/tests/generated\test_merchant_03_收银台.py -v              # 无头模式
  pytest admin-web/tests/generated\test_merchant_03_收银台.py -k "test_fyxt"  # 只跑编号含fyxt的
"""
import pytest
import sys
