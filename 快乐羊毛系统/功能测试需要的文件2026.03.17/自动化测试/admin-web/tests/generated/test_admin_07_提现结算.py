...
运行方法:
  pytest admin-web/tests/generated\test_admin_07_提现结算.py -v --headed     # 有界面
  pytest admin-web/tests/generated\test_admin_07_提现结算.py -v              # 无头模式
  pytest admin-web/tests/generated\test_admin_07_提现结算.py -k "test_fyxt"  # 只跑编号含fyxt的
"""
import pytest
import sys
