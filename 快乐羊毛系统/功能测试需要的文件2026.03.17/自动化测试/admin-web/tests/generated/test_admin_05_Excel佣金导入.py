# -*- coding: utf-8 -*-
"""
admin_05_Excel佣金导入 · 自动化测试
共 7 条用例
来源模块: Excel佣金导入 (完整测试)

运行方法:
  pytest admin-web/tests/generated\test_admin_05_Excel佣金导入.py -v --headed     # 有界面
  pytest admin-web/tests/generated\test_admin_05_Excel佣金导入.py -v              # 无头模式
  pytest admin-web/tests/generated\test_admin_05_Excel佣金导入.py -k "test_fyxt"  # 只跑编号含fyxt的
"""
import pytest
import sys
