# -*- coding: utf-8 -*-
"""
13_商家端_商家端-账号体系 · 自动化测试
来源文件: 13_商家端_商家端-账号体系.xlsx
用例数量: 15 条

运行方法:
  cd admin-web
  pytest tests/generated/test_13_商家端_商家端-账号体系.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_13_商家端_商家端-账号体系.py -v              # 无头模式
  pytest tests/generated/test_13_商家端_商家端-账号体系.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
