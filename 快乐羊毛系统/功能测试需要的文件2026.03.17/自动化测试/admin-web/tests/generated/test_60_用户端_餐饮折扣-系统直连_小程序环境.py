# -*- coding: utf-8 -*-
"""
60_用户端_餐饮折扣-系统直连(小程序环境) · 自动化测试
来源文件: 60_用户端_餐饮折扣-系统直连(小程序环境).xlsx
用例数量: 4 条

运行方法:
  cd admin-web
  pytest tests/generated/test_60_用户端_餐饮折扣-系统直连_小程序环境.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_60_用户端_餐饮折扣-系统直连_小程序环境.py -v              # 无头模式
  pytest tests/generated/test_60_用户端_餐饮折扣-系统直连_小程序环境.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
...
class Test餐饮折扣系统直连小程序环境:
    """60_用户端_餐饮折扣-系统直连(小程序环境) (4条)"""
    ...
    #   5. 计算结果正确显示
        #
        # ── 备注: 小程序input的type="digit"唤起带小数点的数字键盘 ──
