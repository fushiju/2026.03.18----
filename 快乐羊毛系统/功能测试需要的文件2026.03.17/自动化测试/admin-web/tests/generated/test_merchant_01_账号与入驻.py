# -*- coding: utf-8 -*-
"""
merchant_01_账号与入驻 · 自动化测试
共 19 条用例
来源模块: 品牌账号管理, 商家端-账号体系

运行方法:
  pytest admin-web/tests/generated\test_merchant_01_账号与入驻.py -v --headed     # 有界面
  pytest admin-web/tests/generated\test_merchant_01_账号与入驻.py -v              # 无头模式
  pytest admin-web/tests/generated\test_merchant_01_账号与入驻.py -k "test_fyxt"  # 只跑编号含fyxt的
"""
import pytest
import sys
...
class Test账号与入驻:
    ...
    def test_sjzh_002(self, page):
        """[sjzh-002] 验证运营审核通过后商户主账号创建成功  [P1]"""
        # ── 前置条件 ──
    ...
    def test_sjzh_005(self, page):
        """[sjzh-005] [反向] 验证营业执照未上传时提交入驻失败  [P3]"""
        # ── 前置条件 ──
        #   进入商户入驻页面
        #
        # ── 测试步骤 ──
    ...
    def test_sjzh_006(self, page):
        """[sjzh-006] [反向] 验证联系电话格式错误时提交失败  [P3]"""
        # ── 前置条件 ──
        #   进入商户入驻页面
        #
        # ── 测试步骤 ──
    ...
    def test_sjzh_013(self, page):
        """[sjzh-013] [反向] 验证手机号重复时创建子账号失败  [P3]"""
        # ── 前置条件 ──
