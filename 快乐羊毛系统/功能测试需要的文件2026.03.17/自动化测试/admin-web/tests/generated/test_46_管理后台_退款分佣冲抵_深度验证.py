# -*- coding: utf-8 -*-
"""
46_管理后台_退款分佣冲抵(深度验证) · 自动化测试
来源文件: 46_管理后台_退款分佣冲抵(深度验证).xlsx
用例数量: 6 条

运行方法:
  cd admin-web
  pytest tests/generated/test_46_管理后台_退款分佣冲抵_深度验证.py -v --headed     # 看浏览器操作
  pytest tests/generated/test_46_管理后台_退款分佣冲抵_深度验证.py -v              # 无头模式
  pytest tests/generated/test_46_管理后台_退款分佣冲抵_深度验证.py -k "test_xxx"   # 只跑某条
"""
import os
import sys
import pytest
...
class Test退款分佣冲抵深度验证:
    """46_管理后台_退款分佣冲抵(深度验证) (6条)"""
