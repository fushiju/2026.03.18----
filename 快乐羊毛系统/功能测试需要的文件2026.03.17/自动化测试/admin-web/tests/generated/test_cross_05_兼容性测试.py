# -*- coding: utf-8 -*-
"""
cross_05_兼容性测试 · 自动化测试
共 4 条用例
来源模块: 兼容性测试 (用户端小程序)

运行方法:
  pytest admin-web/tests/generated\test_cross_05_兼容性测试.py -v --headed     # 有界面
  pytest admin-web/tests/generated\test_cross_05_兼容性测试.py -v              # 无头模式
  pytest admin-web/tests/generated\test_cross_05_兼容性测试.py -k "test_fyxt"  # 只跑编号含fyxt的
"""
import pytest
import sys
